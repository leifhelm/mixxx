...
TraktorS2MK1.registerOutputPackets = function() {
    ...
    // TraktorS2MK1.linkDeckOutputs("keylock", TraktorS2MK1.outputCallbackDark);
...
TraktorS2MK1.lightDeck = function(group) {
    ...
    for (var packetName in this.controller.OutputPackets) {
        ...
        // TraktorS2MK1.setPlayIndicator(engine.getValue(group, "!play_indicator"), group, "!play_indicator");
    }
...
TraktorS2MK1.setPflMode = function(group, value) {
    HIDDebug(TraktorS2MK1.pflConnections[group]);
